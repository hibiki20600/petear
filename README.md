...
### hover時にサイズが変わるjsとスライドすると浮かび上がってくるjs、グループの中の画像が一つ一つ現れるjs、文字が動くjsを入れています :exclamation:
### 
## Message
...
### 自分がフォローしたグループと加入しているグループに飛ぶ事ができます。編集でも自分の画像がわかる様に非同期通信を利用しています。
## MemberPage
![DEMO](https://user-images.githubusercontent.com/57179721/72693641-03409d00-3b75-11ea-8da1-8071606043ac.gif)
### Ownerが自分だった場合、上の様にフォローしているメンバーを退会させたり加えたりする事ができます。また、右上の解散するを押すと確認ボタンが出てOKを押すとグループを削除できる様になっています :smile:
## SearchPage
